...
import space_habit_frontier.data_model.StringBitBinding;
...
public class Todos extends TableImpl<TodosRecord> {
    ...
    /**
     * The column <code>public.todos.duedatetime</code>.
     */
    public final TableField<TodosRecord, OffsetDateTime> DUEDATETIME = createField(DSL.name("duedatetime"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");

    /**
     * The column <code>public.todos.effectivedatetime</code>.
     */
    public final TableField<TodosRecord, OffsetDateTime> EFFECTIVEDATETIME = createField(DSL.name("effectivedatetime"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");

    /**
     * The column <code>public.todos.streakstartdatetime</code>.
     */
    public final TableField<TodosRecord, OffsetDateTime> STREAKSTARTDATETIME = createField(DSL.name("streakstartdatetime"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
     ...
     */
    public final TableField<TodosRecord, String> WEEKACTIVEDAYS = createField(DSL.name("weekactivedays"), SQLDataType.CHAR(7).nullable(false).defaultValue(DSL.field(DSL.raw("'1111111'::\"bit\""), SQLDataType.CHAR)), this, "", new StringBitBinding());
    ...
    /**
     * The column <code>public.todos.creationdatetime</code>.
     */
    public final TableField<TodosRecord, OffsetDateTime> CREATIONDATETIME = createField(DSL.name("creationdatetime"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
