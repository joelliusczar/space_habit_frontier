...
public class TodosRecord extends UpdatableRecordImpl<TodosRecord> {
    ...
    /**
     * Setter for <code>public.todos.duedatetime</code>.
     */
    public void setDuedatetime(OffsetDateTime value) {
        set(4, value);
    }

    /**
     * Getter for <code>public.todos.duedatetime</code>.
     */
    ...
    /**
     * Setter for <code>public.todos.effectivedatetime</code>.
     */
    public void setEffectivedatetime(OffsetDateTime value) {
        set(5, value);
    }

    /**
     * Getter for <code>public.todos.effectivedatetime</code>.
     */
    ...
    /**
     * Setter for <code>public.todos.streakstartdatetime</code>.
     */
    public void setStreakstartdatetime(OffsetDateTime value) {
        set(6, value);
    }

    /**
     * Getter for <code>public.todos.streakstartdatetime</code>.
     */
    public OffsetDateTime getStreakstartdatetime() {
    ...
    /**
     * Setter for <code>public.todos.creationdatetime</code>.
     */
    ...
    /**
     * Getter for <code>public.todos.creationdatetime</code>.
     */
     ...
     */
    public TodosRecord(UUID id, String title, String note, Short risk, OffsetDateTime duedatetime, OffsetDateTime effectivedatetime, OffsetDateTime streakstartdatetime, Short repeatcount, Short repeattype, Short repeatrate, String weekactivedays, Integer[] yearactivedays, OffsetDateTime creationdatetime, UUID userid, UUID parenttodoid, Integer[] monthactivedays, Boolean poisonous, OffsetDateTime expirationdatetimestamp, Boolean rateinversionflag, OffsetDateTime deletedtimestamp) {
        super(Todos.TODOS);
        ...
        setStreakstartdatetime(streakstartdatetime);
