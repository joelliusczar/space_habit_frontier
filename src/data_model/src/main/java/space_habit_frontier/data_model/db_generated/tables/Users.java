...
public class Users extends TableImpl<UsersRecord> {
    ...
    /**
     * The column <code>public.users.hashedpw</code>.
     */
    public final TableField<UsersRecord, byte[]> HASHEDPW = createField(DSL.name("hashedpw"), SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>public.users.conditioncode</code>.
     */
    public final TableField<UsersRecord, Integer> CONDITIONCODE = createField(DSL.name("conditioncode"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.creationtimestamp</code>.
     */
    public final TableField<UsersRecord, OffsetDateTime> CREATIONTIMESTAMP = createField(DSL.name("creationtimestamp"), SQLDataType.TIMESTAMPWITHTIMEZONE(6), this, "");

    /**
     * The column <code>public.users.daystart</code>.
     */
    public final TableField<UsersRecord, Short> DAYSTART = createField(DSL.name("daystart"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("6"), SQLDataType.SMALLINT)), this, "");

    /**
     * The column <code>public.users.deathgoldpenalty</code>.
     */
    public final TableField<UsersRecord, Integer> DEATHGOLDPENALTY = createField(DSL.name("deathgoldpenalty"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.deathlvlpenalty</code>.
     */
    public final TableField<UsersRecord, Integer> DEATHLVLPENALTY = createField(DSL.name("deathlvlpenalty"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.users.adventuremode</code>.
     */
    public final TableField<UsersRecord, Integer> ADVENTUREMODE = createField(DSL.name("adventuremode"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.INTEGER)), this, "");
